...
class Adaboost_terrain:
    ...
    def run(self):
        ...
        n_estimators = 50
        self.log("Number of estimators set to {0}".format(n_estimators))
        
        # Train the k neighbors terrain
        clf = AdaBoostClassifier(DecisionTreeClassifier(max_depth=1, min_samples_split=10), n_estimators=n_estimators)
